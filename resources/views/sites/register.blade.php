...
<section class="search-course-area relative" style="background: unset;">
	...
	<div class="container">
		<div class="row justify-content-between align-items-center">
			...
			<div class="col-lg-6 col-md-6 search-course-right section-gap" style="background: #343a4026;">
				{!! Form::open(['url' => '/postregister', 'class' => 'form-wrap']) !!}
					<h4 class=" pb-20 text-center mb-30">Formulir Pendaftaran</h4>	{!!Form::text('nama_depan', '', ['class' => 'form-control', 'placeholder' => 'Nama Depan']) !!}
